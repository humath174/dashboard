...
<div class="bg-sidebar vh-100 w-50 position-fixed">
            ...
            <div class="img-admin d-flex flex-column align-items-center text-center gap-2">
                <img class="rounded-circle" src="/component/img-admin.jpeg" alt="img-admin" height="120" width="120">
            ...
            <div class=" bg-list d-flex flex-column align-items-center fw-bold gap-2 mt-4 ">
                <ul class="d-flex flex-column list-unstyled">
                    ...
                    <li class="h7"><a class=" nav-link text-dark" href="/img-chr.php"><i
                                    class="fal fa-usd-square me-2"></i> <span>Ajout Photo</span></a></li>
                    ...
                    <li class="h7"><a class=" nav-link text-dark" href="/réa-chr.php"><i
                                    class="fal fa-usd-square me-2"></i> <span>Ajout Réalisation</span></a></li>
