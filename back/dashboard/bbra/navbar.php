        ...
        <div class="position-sticky">
            <div class="list-group list-group-flush mx-3 mt-4">
                ...
                >
                    ...
                    ><span>Traffic Site Web</span>
                </a>
                <a
                        href="/index.php"
                        class="list-group-item list-group-item-action py-2 ripple"
                ><i class="fas fa-lock fa-fw me-3"></i><span>Utilisateurs</span></a
                >

                <a
                        href="etablissement.php"
                        class="list-group-item list-group-item-action py-2 ripple"
                ...
                <a
                        href="devis-rec.php"
                        class="list-group-item list-group-item-action py-2 ripple"
                ><i class="fas fa-users fa-fw me-3"></i><span>Devis</span></a
                >
                <a
                        href="contact-rec.php"
                        class="list-group-item list-group-item-action py-2 ripple"
